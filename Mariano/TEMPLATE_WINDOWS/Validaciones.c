 ...
 *
 */
int val_getIntLowHighLimit(int* destino, char* mensaje,char* mensajeError,int intentos,int lowLimit, int hiLimit)
{
    int retorno = -1,aux;
 ...
 *
 */
int val_getUnsignedIntLowHighLimit(int* destino, char* mensaje,char* mensajeError,int intentos,int lowLimit, int hiLimit)
{
    int retorno = -1,aux;
    char buffer[MAX_INPUT_BUFFER];

 ...
 *
 */
int al_map2(ArrayList* this, void (*pFunc)(void*,int),int porcentaje);

/** \brief filter an array list by functionFilter
 *
 * \param pList ArrayList* Pointer to arrayList
 * \param pointer to funcFilter
 * \return pointer to filtered arraylist
 *
 */
